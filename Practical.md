...
```
# 2. Program to Display Address
```C
include<stdio.h>
int main()
{
    printf("Nishant Kumar\n");
    printf("Near Krishi Vigyaan Kendra\n");
    printf("Gonawa Road\n");
    printf("Harnaut\n");
    printf("Nalanda - 803110\n");
    printf("India\n");
}
``` 
Output of Program:
...
```
# 7. Program to Check Even or Odd Number
```C
#include<stdio.h>
int main()
{
...
```
# 12. Program to Cheak Leap of Year
```C
#include <stdio.h>
int main()
{
...
```
# 14. Program to Find Number is Palindrome or Not
```C
#include <stdio.h>
int main()
{
...
10   8   6  
```
# Program to Substract the Two Matrix
```C
#include<stdio.h>
...
```
# Program to Intialization or Display Structure 
```C
#include <stdio.h>
